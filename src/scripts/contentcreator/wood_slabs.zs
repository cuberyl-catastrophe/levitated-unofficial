...
wyrmwood_slab.setSoundType(SoundType.get("wood"));
...
wyrmwood_fence.setSoundType(SoundType.get("wood"));
...
wyrmwood_fence_gate.setSoundType(SoundType.get("wood"));
...
menril_slab.setSoundType(SoundType.get("wood"));
...
menril_fence.setSoundType(SoundType.get("wood"));
...
menril_fence_gate.setSoundType(SoundType.get("wood"));
